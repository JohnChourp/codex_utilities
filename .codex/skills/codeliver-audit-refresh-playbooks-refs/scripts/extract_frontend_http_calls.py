...
API_GATEWAYS_DEFAULT = "/home/dm-soft-1/.codex/playbooks/codeliver-api-gateways.md"
...
def main():
    parser = argparse.ArgumentParser(description="Extract HttpClient calls from CodeDeliver services.")
    parser.add_argument("--root", default="/home/dm-soft-1/Downloads/projects", help="Projects root")
