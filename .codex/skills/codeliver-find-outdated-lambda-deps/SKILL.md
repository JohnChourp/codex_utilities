...
description: Scan all local lambda repos under codeliver_all and write a JSON report with dependencies and devDependencies that have newer stable npm versions.
---
