...
description: Scan all local lambda repos under paneldf_all and write a text report with dependencies and devDependencies that have newer stable npm versions.
---
