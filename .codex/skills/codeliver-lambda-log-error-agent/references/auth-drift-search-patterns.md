...
```bash
rg -n "login|renew-token|authorizer|user_does_not_exist|no_user_found" ~/Downloads/lambdas/codeliver_all/codeliver-pos-*
rg -n "login|renew-token|authorizer|user_does_not_exist|no_user_found" ~/Downloads/lambdas/codeliver_all/codeliver-panel-*
rg -n "login|renew-token|authorizer|user_does_not_exist|user_not_found" ~/Downloads/lambdas/codeliver_all/codeliver-sap-*
rg -n "login|renew-device-token|authorizer|delivery_guy_does_not_exist|device_does_not_exist" ~/Downloads/lambdas/codeliver_all/codeliver-app-*
```
