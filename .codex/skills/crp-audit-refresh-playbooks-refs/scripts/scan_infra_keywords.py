...
DEFAULT_OUT = str(Path.home() / ".codex" / "refs" / "crp-infra-scan.generated.md")
...
def main():
    ...
    parser.add_argument("--root", default=str(Path.home() / "Downloads" / "lambdas" / "crp_all"), help="CRP lambdas root")
