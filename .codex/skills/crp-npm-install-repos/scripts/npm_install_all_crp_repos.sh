...
ROOT="${HOME}/Downloads/lambdas/crp_all"
DRY_RUN=0
...
usage() {
  cat <<'USAGE'
Usage:
  npm_install_all_crp_repos.sh [--root <path>] [--dry-run]

Options:
  --root <path>   Root folder with local repos (default: ~/Downloads/lambdas/crp_all)
